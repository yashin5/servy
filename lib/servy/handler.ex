defmodule Servy.Handler do
  ...
  def rewrite_path(%{path: "/wilflife"} = conv) do
  ...
  @spec parse(binary()) :: %{method: binary(), path: binary(), resp_body: <<>>, status: nil}
  ...
  @spec route(%{path: any(), resp_body: any(), status: any()}) :: %{
          path: any(),
  ...
  def handle_file({:error, _enoent}, conv) do
